...
class  NewsStory(object):#代表一则新闻，其所含有的信息
    def  _init_(self,guid,title,description,link,pubdate):
        self.guid=guid
        self.title=title
...
# Triggers
#======================
#trigger是筛选新闻故事的规则机制，它以下有着不同子类
class Trigger(object):
    def evaluate(self, story):#不会直接执行这个类，真正需要执行的是它各个子类的evaluate函数
    #如果你忘记给子类设置这个函数，它就会调用父类的evaluate函数，然后引发异常
        """
...
class PhraseTrigger(Trigger):
    ...
    def is_phrase_in(self,text):
        ...
        if ' '+self.phrase+' ' in ' '+new_text+' ':
            ...
            return False
# test_phrase=PhraseTrigger('purple cow')
# print(test_phrase.is_phrase_in('purple@#$%cow')      
...
# Problem 7
# TODO: NotTrigger
class NotTrugger(Trigger):
    def __init__(self,other):
        self.trigger=other
    def evaluate(self,story):
        return not self.trigger.evaluate(self,story)
# Problem 8
# TODO: AndTrigger
class AndTrigger(Trigger):
    def __init__(self,one,another):
        self.trigger1=one
        self.trigger2=another
    def evaluate(self,story):
        return self.trigger1.evaluate(self,story) and self.trigger2.evaluate(self,story)
# Problem 9
# TODO: OrTrigger
class OrTrigger(Trigger):
    def __init__(self,one,another):
        ...
        self.trigger2=another
    def evaluate(self,story):
        return self.trigger1.evaluate(self,story) or self.trigger2.evaluate(self,story)
